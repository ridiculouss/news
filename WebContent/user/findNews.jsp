				...
				<TBODY>
					...
					<tr align="center" style=" HEIGHT: 30px; font-size: 14px; ">
						<td class="ta_01" align="center" bgColor="#afd1f3">
							...
							<a href="${pageContext.request.contextPath }/userNews_findByUid.action?page=1">首页</a>|
							<a href="${pageContext.request.contextPath }/userNews_findByUid.action?page=<s:property value="pageBean.page-1"/>">上一页</a>|
							</s:if>
							<s:if test="pageBean.page != pageBean.totalPage">
							<a href="${pageContext.request.contextPath }/userNews_findByUid.action?page=<s:property value="pageBean.page+1"/>">下一页</a>|
							<a href="${pageContext.request.contextPath }/userNews_findByUid.action?page=<s:property value="pageBean.totalPage"/>">尾页</a>|
							</s:if>
						</td>
					</tr>
				</TBODY>
