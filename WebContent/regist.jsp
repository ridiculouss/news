...
<script type="text/javascript">
	...
	function checkRePassword() {
		...
		if (password != (rePassword)) {
			$("rePasswordInfo").innerHTML = "两次密码不一致!";
		}else {
	...
	function checkUserName() {
		...
		if(username == null || username == ""){
			$("usernameInfo").innerHTML = "<font color='red'>用户名不能为空!</font>";
		}else {
			xmlHttp.onreadystatechange=function(){
				if(xmlHttp.readyState==4 && xmlHttp.status==200){
					$("usernameInfo").innerHTML = xmlHttp.responseText;
				}
			};
			/* xmlHttp.open("get", "user_findByName?userName="+username, true);
			xmlHttp.send(null); */
			
		    xmlHttp.open("post", "user_findByName", true);
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" action="${pageContext.request.contextPath}/user_regist.action" method="post" novalidate >
						<table>
							<tbody><tr>
								<th>
								...
								<td width="300px">
									<input type="text" id="username" name="uname" class="text" maxlength="20" onblur="checkUserName()" />
								</td>
								<td>
									<span id="usernameInfo"></span>
									<span><font color="red"><s:fielderror fieldName="uname" /></font></span>
								</td>
							</tr>
							<tr>
								<th>
								...
								<td width="300px">
									<input type="password" id="password" name="upassword" class="text" maxlength="20" autocomplete="off" onblur="checkPassword()" />
								</td>
								<td>
									<span><font color="red"><s:fielderror fieldName="upassword" /></font></span>
							...
							<tr>
								...
								<td width="300px">
									<input type="password" id="rePassword" name="rePassword" class="text" maxlength="20" autocomplete="off" onblur="checkRePassword()" />
								</td>
								<td>
							...
							<tr>
								...
								<td>
									<span class="fieldSet">
										<input type="text" id="checkcode" name="checkcode" maxlength="4" autocomplete="off"><img id="checkImage" class="captchaImage" src="${pageContext.request.contextPath}/checkImg.action" onclick="change()" title="点击更换验证码">
									</span>
								</td>
								<td>
									<span><font color="red"><s:fielderror fieldName="checkcodeInfo" /></font></span>
								</td>
							</tr>
							<tr>
								<th>&nbsp;
